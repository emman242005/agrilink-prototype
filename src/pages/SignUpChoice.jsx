    ...
    <div className="min-h-screen bg-forestdark flex items-center justify-center px-6">
      <div className="max-w-md w-full">
        <div className="text-center mb-10">
          ...
          <h1 className="font-display text-xl font-semibold text-paper mt-4">Create an account</h1>
          <p className="text-sm text-paper/70 mt-1">Choose how you'd like to join</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-sage">Apply for a loan through your MFI</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-sage">Register your institution as a lending partner</p>
            </div>
          </Link>
        </div>
